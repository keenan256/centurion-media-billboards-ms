...
//Get all data in billboards table enddate is greater than current date
$sql = "SELECT * FROM billboards WHERE enddate < CURRENT_DATE";
$stmt = $db->prepare($sql);
$stmt->execute();
...
<body>
    <div class="container">
        <h1>Expired Rental Contracts</h1>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    if ($billboard['status'] == 'active') {
                                        ...
                                        //Display days left
                                        //Background red and text white
                                        if ($daysleft < 0) {
                                            echo '<span style="background-color:red; color:white; padding:5px;">' . $daysleft . '</span>';
                                        } else {
                                            echo '<span style="background-color:red; color:white; padding:5px;">' . $daysleft . '</span>';
                                        }
                                    } else {
